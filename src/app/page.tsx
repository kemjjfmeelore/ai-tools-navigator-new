  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <main className="container mx-auto p-4 py-8">
        <h1 className="text-4xl font-bold mb-8 text-center">AI Audio & Video Tools Navigator</h1>
          ...
          {allToolsData.map((tool) => (
            <div key={tool.slug} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group relative">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                Category: <span className="font-medium text-blue-600 dark:text-blue-400">{tool.category}</span>
              </p>
