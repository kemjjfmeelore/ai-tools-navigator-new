      ...
      <main className="container mx-auto p-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {allToolsData.map((tool) => (
            <div key={tool.slug} className="card bg-base-200 border border-base-300 rounded-xl shadow-xl p-6 hover:shadow-primary-glow hover:border-primary transition-all duration-300 group relative">
              ...
              <h2 className="text-3xl font-semibold mb-2 text-primary group-hover:text-primary-focus transition-colors duration-300">{tool.name}</h2>
              ...
              <Link href={tool.website_url} target="_blank" rel="noopener noreferrer" className="relative z-20 btn btn-primary btn-outline">
                Visit Website
              </Link>
            </div>
          ))}
